...
<html>
    ...
    <body id="contenedor">
        ...
        <div id="derechaSmartphone">
            ...
            <div id="pausaSmartphone">MenÃº</div>
        ...
        <div id="gameOver">
            <h2>Â¡Â¡Â¡GAME OVER!!!</h2>
            Â¡IntÃ©ntalo de nuevo! <br>
        ...
        <div id="userWin">
            <h2>Â¡Â¡Â¡ENHORABUENA!!!</h2>
            La NASA estarÃ­a orgullosa de contar con pilotos como tÃº...<br><br>
        ...
        <div id="menuInstrucciones">
            ...
            <h3>INSTRUCCIONES</h3>
            <p>El juego consiste en frenar la caÃ­da de la nave mediante el uso del motor, utiliza la tecla <b>&nbsp;&nbsp;espacio&nbsp;&nbsp;</b> o el botÃ³n <b>ON</b> para la version smartphone, para que esta pueda aterrizar adecuadamente sobre la superficie lunar.<br><br>Si el jugador no frena lo suficientemente la caÃ­da de la nave ,a una <b>velocidad inferior a los 5 m/s</b>, esta se estrellarÃ¡ y el jugador no superarÃ¡ el juego.<br><br> AdemÃ¡s hay que tener en cuenta que la nave cuenta con un medidor de gasolina que se acabarÃ¡ si el jugador abusa del uso del motor de la nave.</p>
        ...
        <div id="settings">
            ...
            <p>Dificultad del juego:<br>
                (Disminuye el depÃ³sito de gasolina)<br>
                <button id="dificultad">FÃ¡cil</button><br><br>
                Modelo luna:<br>
                <button id="modeloLuna">Amarilla</button>
            </p>
            Modelo nave:<br>
            <button id="modeloNave">Modelo EstÃ¡ndar</button><br><br>
